...
import fr.mathip.azplugin.bukkit.azclientapi.utils.AZColor;
                ...
                if (args.length > 2) {
                    if (Bukkit.getPlayer(args[1]) != null) {
                        ...
                        try {
                            ...
                            target.getWorld().getPlayers().forEach(pl -> PacketPlayerScale.setScale(target, size, size, size, size, size, size,pl));
                ...
                if (args.length > 2){
                    if (Bukkit.getPlayer(args[1]) != null){
                        ...
                        try {
                            ...
                            target.getWorld().getPlayers().forEach(pl -> PacketPlayerModel.setModel(target, plspPlayerModel, pl));
                            commandSender.sendMessage("§achangement de skin effectué !");
                    ...
                    if (Bukkit.getPlayer(args[1]) != null){
                        ...
                        try {
                            ...
                            if (opacity <= 1 && opacity >= -1) {
                                ...
                                target.getWorld().getPlayers().forEach(pl -> PacketPlayerOpacity.setOpacity(target, opacity, pl));
                    ...
                    if (Bukkit.getPlayer(args[1]) != null){
                        ...
                        if (args[2].equalsIgnoreCase("reset")) {
                              if (main.playersTag.containsKey(target)) {
                                  ...
                                  target.getWorld().getPlayers().forEach(pl -> {
                                      PacketPlayerTag.setNameTag(target, "", pl);
                                  });
                        ...
                        target.getWorld().getPlayers().forEach(pl -> PacketPlayerTag.setNameTag(target, sb.toString(), pl));
                    ...
                    if (Bukkit.getPlayer(args[1]) != null){
                        ...
                        if (args[2].equalsIgnoreCase("reset")) {
                            if (main.playersSubTag.containsKey(target)) {
                                ...
                                target.getWorld().getPlayers().forEach(pl -> {
                                    PacketPlayerTag.setSubTag(target, "", pl);
                                });
                                commandSender.sendMessage("§aTag supprimé !");
                            }
                            return true;
                        ...
                        target.getWorld().getPlayers().forEach(pl -> PacketPlayerTag.setSubTag(target, sb.toString(), pl));
                        commandSender.sendMessage("§atag modifié !");
                    } else {
                        commandSender.sendMessage("§cCe joueur est hors-ligne !");
                    }
                    ...
                    if (Bukkit.getPlayer(args[1]) != null){
                        ...
                        if (args[2].equalsIgnoreCase("reset")) {
                            if (main.playersSupTag.containsKey(target)) {
                                ...
                                target.getWorld().getPlayers().forEach(pl -> {
                                    PacketPlayerTag.setSupTag(target, "", pl);
                                });
                                commandSender.sendMessage("§aTag supprimé !");
                            }
                            return true;
                        ...
                        target.getWorld().getPlayers().forEach(pl -> PacketPlayerTag.setSupTag(target, sb.toString(), pl));
                        commandSender.sendMessage("§atag modifié !");
                    } else {
                        commandSender.sendMessage("§cCe joueur est hors-ligne !");
                    }
                    ...
                    if (Bukkit.getPlayer(args[1]) != null) {
                        ...
                        if (args.length >= 3) {
                            if (args[2].equalsIgnoreCase("on")) {
                                ...
                                commandSender.sendMessage("§c/az seechunks <joueur> [on/off]");
                            }
                            return true;
                        }
                        if (main.playersSeeChunks.contains(target)) {
                            ...
                            PacketConf.setFlag(target, PLSPConfFlag.SEE_CHUNKS, true);
                            main.playersSeeChunks.add(target);
                        }
                    } else {
